...
function renderPatrimonyChart(allKnownOps) {
    ...
    sortedMonths.forEach(monthKey => {
        ...
        // Cada ponto representa o total acumulado de quantidade x preço das vendas planejadas.
        accumulatedSellValue += dataObj.sell;
        sellValues.push(accumulatedSellValue);
    ...
    patrimonyChartInstance = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                ...
                createChartDataset('buy', 'Compras Planejadas (acumulado)', buyValues, '#f87171'),
                createChartDataset('sell', 'Vendas Planejadas (acumulado)', sellValues, '#34d399'),
